...
export default function Jobs() {
  ...
  useEffect(() => { getAll('jobs').then(setData); }, []);
  ...
  return (
    <div className="p-6">
      <PageHeader title="Job Postings" subtitle="Manage open positions"
        actions={<button className="px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity">Post Job</button>}
      />
