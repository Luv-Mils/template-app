...
export default function Surveys() {
  ...
  useEffect(() => { getAll('surveys').then(setData); }, []);
  ...
  return (
    <div className="p-6">
      <PageHeader title="Surveys" subtitle="Create and manage surveys"
        actions={<button className="px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity">New Survey</button>}
      />
