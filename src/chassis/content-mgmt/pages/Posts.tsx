...
export default function Posts() {
  ...
  useEffect(() => { getAll('posts').then(setData); }, []);
  ...
  return (
    <div className="p-6">
      <PageHeader title="Posts" subtitle="Manage your content"
        actions={<button className="px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity">New Post</button>}
      />
