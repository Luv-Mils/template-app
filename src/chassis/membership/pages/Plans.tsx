...
export default function Plans() {
  ...
  useEffect(() => { getAll('plans').then(setData); }, []);
  ...
  return (
    <div className="p-6">
      <PageHeader title="Plans" subtitle="Manage subscription tiers"
        actions={<button className="px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity">New Plan</button>}
      />
